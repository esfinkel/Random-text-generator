# Elisabeth Finkel
# December 2017
# Credits to http://www.physics.cornell.edu/~myers/teaching/ComputationalMethods/ComputerExercises/
#
...
def read_file_into_word_list(filename):
    ...
    translator = maketrans(string.punctuation, ' '*len(string.punctuation))
